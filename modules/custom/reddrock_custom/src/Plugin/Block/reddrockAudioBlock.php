...
class reddrockAudioBlock extends BlockBase {
  ...
  public function build() {
    return [
      '#markup' => '<div class="mytooltip"><span class="tooltiptext">Turn the switch on to experience original music and sounds of ReddRock!  Hover your mouse or click to experience!</span><span class="checkbox-label">SOUNDS:</span><label class="switch"><input id="audioswitch" type="checkbox"><span class="slider"></span></label></div>',
